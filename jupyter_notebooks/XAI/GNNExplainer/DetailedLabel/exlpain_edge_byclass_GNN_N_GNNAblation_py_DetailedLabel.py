...
print("Test_Graph_DetailedLabel ******************")
print(Test_Graph)
print(Test_Graph_ab)
print("*******************************************")
...
indx_edges_to_explain = pd.read_csv('/home/ahmed/GNN-Based-ANIDS/GNN-Based-ANIDS/jupyter_notebooks/XAI/GNNExplainer/DetailedLabel/Models/Edges_to_explain_DetailedLabel.csv', encoding="ISO-8859–1", dtype = str)
...
results_df = pd.DataFrame(columns = ['Edge_indx', 'label', 'in_out_degrees', 'loss'])
...
for i, x in enumerate(indx_edges_to_explain['Edge_indx']):
    ...
    results_df.loc[-1] = [x, indx_edges_to_explain['label'][i], indx_edges_to_explain['in_out_degrees'][i], loss]  # adding a row
    results_df.index = results_df.index + 1  # shifting index


results_df.to_csv(f'/home/ahmed/GNN-Based-ANIDS/GNN-Based-ANIDS/jupyter_notebooks/XAI/GNNExplainer/DetailedLabel/Models/Final_results_DetailedLabel_Final.csv', sep=',', index = False)
print(results_df)
