''''
        ...
        The idea here is to train our model on the CIC-IDS-2017 Dataset, and test it on the CIC-IDS-2018 dataset
'''
...
# ------------------------------------------------ Test ---------------------------------------------------------------------
print("++++++++++++++++++++++++++++ Test ++++++++++++++++++++++++++++++++")
path, dirs, files = next(os.walk("./input/Dataset/CICIDS2018/"))
file_count = len(files)
