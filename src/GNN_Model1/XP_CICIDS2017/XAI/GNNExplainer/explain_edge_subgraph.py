...
def explain_edge_features(model, edge_id, graph, node_feat, edge_feat, **kwargs):
    ...
    class_weights2 = class_weight.compute_class_weight(class_weight = 'balanced',
                                                        classes = np.unique(sg.edata['label'].cpu().numpy()),
                                                        y = sg.edata['label'].cpu().numpy())
    ...
    return edge_indice, sg, efeat_mask
...
def explain_edges(model, edge_id, graph, node_feat, edge_feat, **kwargs):
    ...
    return edge_indice, sg, edge_mask
...
edge_indice1, sub_graph1, efeat_mask = explain_edge_features(model1, 2001, G1_test, node_features_test1, edge_features_test1)
edge_indice2, sub_graph2, edge_mask = explain_edges(model1, 2001, G1_test, node_features_test1, edge_features_test1)
...
print()
print("explain_edge_features results :")
print("sub_graph : ", sub_graph1)
print("edge_indice : ", edge_indice1)

print()
print("explain_edges results :")
print("sub_graph : ", sub_graph2)
print("edge_indice : ", edge_indice2)