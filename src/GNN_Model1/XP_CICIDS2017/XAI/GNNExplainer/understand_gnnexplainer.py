...
print(val_data.edge_label_index[:, 0])
print("+++++++++++++++++++++++++++++++++++")


# train val and test are all the same dataset, containing 2708 documents (instances)
# and for each instance we have 1433 unique word (features) so with that we will have a 2708x1433 matrix
# each aij value from the matrix represents a 0/1-value describing wether or not the word j is in the document i
