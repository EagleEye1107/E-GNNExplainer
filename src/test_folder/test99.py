...
datafile = "./input/Dataset/GlobalDataset/CIC-IDS-2017-Dataset.csv"

df = pd.read_csv(f'{datafile}', encoding="ISO-8859–1", dtype = str)
df_values = df.values
...
# Print Results
print()
print(f'datafile contains -> {att_count} attribute and labels are [ {df[" Label"].value_counts()} ]')
